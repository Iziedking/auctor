...
function readError(value:Record<string,unknown>,fallback:string){return typeof value.detail==="string"?value.detail:typeof value.message==="string"?value.message:fallback}
