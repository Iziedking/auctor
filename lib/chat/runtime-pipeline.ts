...
interface RuntimeChatConfig { readonly mockMode: boolean; readonly keeperhub: { readonly baseUrl: string; readonly apiKey: string | null; readonly walletAddress: string | null }; readonly ownerAddress?:Address }
